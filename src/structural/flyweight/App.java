...
public class App {
    public static void main(String[] args) {
        ...
        shop.takeOrder(CoffeeFlavour.LATTE, CoffeeLatteArt.CAT, 12);
        shop.takeOrder(CoffeeFlavour.AFFOGATO, CoffeeLatteArt.CAT, 13);
        ...
        shop.takeOrder(CoffeeFlavour.CAPPUCCINO,CoffeeLatteArt.CAT,11);
